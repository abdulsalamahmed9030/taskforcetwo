export default function AboutText() {
  return (
    <div className="bg-[#ffffff] text-gray-700 px-4 md:px-12 py-12">
      <div className="max-w-7xl mx-auto text-base sm:text-lg leading-relaxed">
        <p className="mb-4">
          <strong>Taskforce Interiors</strong> is a renowned company led by a
          team of seasoned professionals specializing in civil works, interior
          decorating, and overseeing turnkey projects. With a proven track
          record in the industry, we take pride in our ability to deliver
          exceptional results with unmatched precision and creativity.
        </p>
        <p className="mb-4">
